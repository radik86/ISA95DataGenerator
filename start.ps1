# ISA95 Data Generator - Start Script
# This script stops existing processes, rebuilds, and starts both backend and frontend

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "ISA95 Data Generator - Start Script" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
